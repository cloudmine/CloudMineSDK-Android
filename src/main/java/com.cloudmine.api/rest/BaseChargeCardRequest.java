...
public class BaseChargeCardRequest extends CloudMineRequest<PaymentResponse> {
     ...
     */
    @Expand
    public BaseChargeCardRequest(int cardIndex, String cart, CMSessionToken sessionToken, @Optional CMServerFunction serverFunction, @Optional Response.Listener<PaymentResponse> successListener, Response.ErrorListener errorListener) {
        super(Method.POST, URL, "{ \"cart\":" + cart + ", \"paymentInfo\":{\"index\":" + cardIndex + ", \"type\":\"card\"}}", sessionToken, serverFunction, successListener, errorListener);
    }
